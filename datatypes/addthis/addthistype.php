<?php
/**
 * File containing the addthisType class.
 */

class addthisType extends eZDataType
{
    const DATA_TYPE_STRING = 'addthis';
    const MAX_LEN_FIELD = 'data_int1';
    const MAX_LEN_VARIABLE = '_addthis_max_string_length_';
    const DEFAULT_STRING_FIELD = "data_text1";
    const DEFAULT_STRING_VARIABLE = "_addthis_default_value_";
    ...
    */
    ...
    {
        $this->eZDataType( self::DATA_TYPE_STRING, ezpI18n::tr( 'kernel/classes/datatypes', 'AddThis', 'Datatype name' ),
    ...
    */
    ...
    function validateObjectAttributeHTTPInput( $http, $base, $contentObjectAttribute )
    {
        ...
        {
            $data = trim( $http->postVariable( $base . '_addthis_data_text_' . $contentObjectAttribute->attribute( 'id' ) ) );
...
addthisType::register( addthisType::DATA_TYPE_STRING, 'addthisType' );